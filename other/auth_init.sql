...
CREATE TABLE auth_dataset_userset (
  ...
  UserSetId                 INT,
  UNIQUE INDEX idx_DataSetId_Capability (DataSetId,Capability),
...
INSERT IGNORE INTO auth_datas              SET DatagroupId  =1000000001      ,Repository='127.0.0.1/mysql',DatabaseName='kddart_v2_3_2',TableName='project',RowWhereClause='',ColumnList='ProjectId,ProjectManagerId,TypeId,ProjectName,ProjectStatus,ProjectStartDate,ProjectEndDate';
INSERT IGNORE INTO auth_datas              SET DatagroupId  =0               ,Repository='127.0.0.1/mysql',DatabaseName='kddart_v2_3_2',TableName='site'   ,RowWhereClause='',ColumnList='SiteId,SiteName,SiteAcronum,CurrentSiteManager';
